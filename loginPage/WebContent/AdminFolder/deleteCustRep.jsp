...
<html>
	<head>
		...
		<title>Deleting A Customer Representative</title>
	</head>
	<body>
		<%
			try {
 ...
 */
	...
	//			int rows = stmt.executeUpdate("INSERT into rep_logins Values (\"" + username + "\", \"" + password + "\", \"" + firstName + "\", \"" + lastName + "\");");
				...
				if(!result.next())
				{
					...
					stmt.executeUpdate("Delete from rep_logins where username = '" + username + "';");
					
					out.println("Customer Representative Successfully Deleted");
